...
namespace BuberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20230613163955_InitialCreate")]
            ...
            modelBuilder.Entity("BuberDinner.Domain.MenuAggregate.Menu", b =>
                {
                    ...
                    b.OwnsMany("BuberDinner.Domain.MenuAggregate.Enitites.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("BuberDinner.Domain.MenuAggregate.Enitites.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
